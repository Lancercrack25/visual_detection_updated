...
: ${AMENT_CURRENT_PREFIX:="/home/luis/my_ws/src/install/multicamera"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multicamera/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/multicamera/environment/path.sh"
