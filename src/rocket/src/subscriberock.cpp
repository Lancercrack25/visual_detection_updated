...
{
public:
    CameraSubscriberNode() : Node("camera_subscriberock_node")
    {
        // Suscribirse al tópico /camara/image/compressed
        image_sub_ = this->create_subscription<sensor_msgs::msg::CompressedImage>(
            "/camara/rock_image/compressed", 10, std::bind(&CameraSubscriberNode::image_callback, this, std::placeholders::_1));
    }
