...
#include "my_msgs/msg/detail/camara_mensajes__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msgs::msg::CamaraMensajes & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_msgs::msg::CamaraMensajes & ros_message)
{
  // Member: camera_id
  cdr >> ros_message.camera_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_msgs
max_serialized_size_CamaraMensajes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs::msg::CamaraMensajes;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_msgs
max_serialized_size_key_CamaraMensajes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_msgs::msg::CamaraMensajes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msgs::msg::CamaraMensajes *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CamaraMensajes__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_msgs::msg::CamaraMensajes *>(
...
static size_t _CamaraMensajes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CamaraMensajes(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CamaraMensajes__callbacks = {
  "my_msgs::msg",
  "CamaraMensajes",
...
static rosidl_message_type_support_t _CamaraMensajes__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CamaraMensajes__callbacks,
...
{
  return &my_msgs::msg::typesupport_fastrtps_cpp::_CamaraMensajes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgs, msg, CamaraMensajes)() {
  return &my_msgs::msg::typesupport_fastrtps_cpp::_CamaraMensajes__handle;
}
