...
class Metaclass_CamaraMensajes(type):
    """Metaclass of message 'CamaraMensajes'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_msgs.msg.CamaraMensajes')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__camara_mensajes
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__camara_mensajes
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__camara_mensajes
            cls._TYPE_SUPPORT = module.type_support_msg__msg__camara_mensajes
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__camara_mensajes
...
class CamaraMensajes(metaclass=Metaclass_CamaraMensajes):
    """Message class 'CamaraMensajes'."""
